...
{
    public abstract class WishWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WishWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WishWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WishDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WishDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WishDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WishDbContext, Task<T>> func)
        {
            T result;
